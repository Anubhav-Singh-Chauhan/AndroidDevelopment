...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(ENUM.equalsIgnoreCase("NONE")){
            startActivity(new Intent(this,NumberRegister.class));
        }else {
    ...
    public void stopService(View view) {
        Intent notificationIntent = new Intent(this,Service1.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.changeNum){
                    startActivity(new Intent(MainActivity.this,NumberRegister.class));
                }
                return true;
            }
        });
